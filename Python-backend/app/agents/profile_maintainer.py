...
## 更新规则
1. **学习风格维度**: 调整幅度建议在 0.1-0.3 之间，系统会自动累加到当前值
2. **列表字段**: 提供新增的项目，系统会自动合并去重
...
### 示例2：识别知识基础
用户说："我已经学过 Python 基础和 Redis，现在想学 AI agent"

输出：
{
  "should_update": true,
  "update_reason": "用户提供知识基础信息",
  "updates": {
    "knowledge_base": ["Python", "Redis"],
    "interest_tags": ["AI agent"]
  },
  "confidence": 1.0,
  "analysis": "用户明确说明已掌握 Python 和 Redis，对 AI agent 感兴趣"
}"""
